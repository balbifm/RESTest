...
import es.us.isa.restest.generators.FBTestCaseGenerator;
...
//	private static String propertiesFilePath = "src/test/resources/Folder/api.properties";
    private static String propertiesFilePath = "runs/bp-30k/api-bp.properties";
//    private static String propertiesFilePath = "runs/gkohl/api.properties";
//    private static String propertiesFilePath = "runs/petstore/api.properties";
//    private static String propertiesFilePath = "runs/httpbin-to/api.properties";
//    private static String propertiesFilePath = "runs/http-file-upload/api.properties";
    ...
    private static AbstractTestCaseGenerator createGenerator() throws RESTestException {
        ...
        switch (generator) {
            ...
            case "CBT":
                ...
                break;
            case "FB":
                gen = new FBTestCaseGenerator(spec, conf, numTestCases);
                ((FBTestCaseGenerator) gen).setFaultyDependencyRatio(faultyDependencyRatio);
                ((FBTestCaseGenerator) gen).setInputDataMaxValues(inputDataMaxValues);
                ((FBTestCaseGenerator) gen).setReloadInputDataEvery(reloadInputDataEvery);
                gen.setFaultyRatio(faultyRatio);
                break;
            case "ART":
